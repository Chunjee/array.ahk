...
| :------------- | :--------------------------------------------------- | :----------- |
|  value*        | ценить/объект | Необязательный. (По умолчанию `[]`) Массивы и/или значения для объединения в новый массив. |
...
#### Возврат
(boolean): `true`, если все элементы прошли тестовую функцию, иначе `false`, если ни один из них не прошел.
...
| Argument       | Type                       | Description  |
| :------------- | :------------------------- | :----------- |
|  value         | ценить | Необходимый. Значение, которым нужно заполнить массив. |
...
| Argument       | Type         | Description  |
| :------------- | :----------- | :----------- |
|  valueToFind   | *            | Необходимый. Значение для поиска. |
...
| Argument       | Type         | Description  |
| :------------- | :----------- | :----------- |
|  searchElement | ценить        | Необходимый. Значение для поиска. |
|  fromIndex     | число       | Необязательный. (По умолчанию `1`) Индекс, с которого начинается поиск. |
...
| Argument       | Type         | Description  |
| :------------- | :----------- | :----------- |
|  separator     | нить       | Необязательный. (По умолчанию `","`) Указывает строку для разделения каждой пары соседних элементов массива. |
...
| Argument       | Type         | Description  |
| :------------- | :----------- | :----------- |
|  function(accumulator, element, index, array)      |      | Необходимый. Функция, выполняемая для каждого элемента массива (кроме первого, если не указано начальное значение). |
...
|  values*        | ценить/объект | Необязательный. (Default `""`) Значения, добавляемые в массив. |
...
| Argument       | Type         | Description  |
| :------------- | :----------- | :----------- |
|  element*      | ценить/объект | Необходимый. Элементы, добавляемые в начало массива. |
